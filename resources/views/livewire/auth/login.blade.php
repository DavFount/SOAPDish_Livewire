    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-gray-50 dark:bg-gray-800 shadow sm:rounded-lg sm:px-10 custom-shadow">
            <form wire:submit.prevent="authenticate">
                <input wire:model="timezone" type="hidden" name="timezone" id="timezone" value="">
                <div>
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="block ml-2 text-sm text-gray-700 dark:text-gray-400 leading-5">
                            Remember
                        </label>
                    </div>
