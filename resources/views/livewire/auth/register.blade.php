@section('title', 'Create a new account')
    <div>
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-sm text-center text-gray-600 dark:text-gray-400 leading-5 max-w">
                Or
                <a href="{{ route('login') }}"
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="px-4 py-8 bg-gray-50 dark:bg-gray-800 shadow sm:rounded-lg sm:px-10 custom-shadow">
                <form wire:submit.prevent="register">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-400 leading-5">
                            Name
                        </label>
                    ...
                    <div class="mt-6">
                        <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-400 leading-5">
                            Email address
                        </label>
                    ...
                    <div class="mt-6">
                        <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-400 leading-5">
                            Password
                        </label>
                    ...
                    <div class="mt-6">
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-400 leading-5">
                            Confirm Password
                        </label>
